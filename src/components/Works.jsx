...
const Works = () => {
  return (
    <div id="works" className="container mx-auto pt-24 lg:pt-28 xl:pt-32">
      ...
      <div className="mt-12 grid grid-cols-6 gap-7" style={{transform: 'none', transformOrigin: '50% 50% 0px'}}>
        <div className="col-span-6 sm:col-span-3 lg:col-span-2" style={{transform: 'none', transformOrigin: '50% 50% 0px'}}>
            ...
            <div className="portfolio-top relative overflow-hidden">
              <div className="portfolio-image fiximage blur-0 filter transition-all duration-500 group-hover:blur">
                <span style={{boxSizing: 'border-box', display: 'block', overflow: 'hidden', width: 'initial', height: 'initial', background: 'none', opacity: 1, border: '0px', margin: '0px', padding: '0px', position: 'relative'}}>
                  <span style={{boxSizing: 'border-box', display: 'block', width: 'initial', height: 'initial', background: 'none', opacity: 1, border: '0px', margin: '0px', padding: '69.8182% 0px 0px'}}></span>
                  <img src={westFinder} alt="poza" style={{position: 'absolute', inset: '0px', boxSizing: 'border-box', padding: '0px', border: 'none', margin: 'auto', display: 'block', width: '0px', height: '0px', minWidth: '100%', maxWidth: '100%', minHeight: '100%', maxHeight: '100%'}}/>
                </span>
              </div>
              <div className="portfolio-hovercontent absolute left-0 top-0 z-20 flex h-full w-full -translate-x-full transform items-center justify-center gap-4 overflow-hidden bg-grey bg-opacity-80 transition-all duration-500 group-hover:translate-x-0">
                <button className="inline-flex h-20 min-h-0 w-20 items-center justify-center rounded-full bg-primary p-0 text-center text-lg text-grey"><FaGithub size={50}/></button>
                <a href="" className="inline-flex h-20 min-h-0 w-20 items-center justify-center rounded-full bg-primary p-0 text-center text-lg text-grey"><FaExternalLinkAlt /></a>
              </div>
            </div>
            <div className="portfolio-content mt-4">
              <h4>WestFinde3</h4>
              <p>A website with sport clothes.</p>
            </div>
          </div>
        </div>
